...
var processImportBinding = function processImportBinding(binding, currentDirectory) {
  ...
  var sourcePath = fileName.startsWith(".") ? "".concat(currentDirectory, "/").concat(fileName) : "".concat(process.cwd(), "/src/").concat(fileName);
  var p = _fs["default"].existsSync(sourcePath + '.js') ? sourcePath + '.js' : _fs["default"].existsSync(sourcePath + '.tsx') ? sourcePath + '.tsx' : false;
